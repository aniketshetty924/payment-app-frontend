...
import {
  getAllPendingDealersPaymentRequest,
  getClientById,
  processPayments,
...
const DealerPayments = () => {
  ...
  const [filteredClients, setFilteredClients] = useState([]); // State to hold filtered clients
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      const response = await getAllPendingDealersPaymentRequest();
  ...
  const handlePayClick = async () => {
    ...
    try {
      const paymentsToProcess = selectedClient.requests.map((request) => ({
        ...
        recipientType: "dealer", // Set recipientType to "dealer"
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-6">
        ...
        {/* Table showing clients with pending dealer payments */}
        <div className="overflow-x-auto bg-white rounded-lg shadow-md mb-6">
          <h2 className="text-xl font-semibold mb-4">
            Clients with Pending Dealers
          </h2>
            ...
            <table className="w-full table-auto table-fixed">
              <thead className="bg-indigo-600 text-white">
                <tr>
                  ...
                  <th className="py-3 px-4 text-center">Pending Dealers</th>
          ...
          <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50 text-black">
            <div className="bg-white p-8 rounded-lg w-3/4 max-w-4xl">
              <h2 className="text-2xl font-semibold mb-6">
                Dealers Pending for {selectedClient.client.clientName}
              </h2>
              <table className="w-full table-auto table-fixed">
                <thead className="bg-indigo-600 text-white">
                  <tr>
                    <th className="py-3 px-4 text-left">Dealer ID</th>
